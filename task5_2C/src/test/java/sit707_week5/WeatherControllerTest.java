...
public class WeatherControllerTest {
	...
	*/
	...
	public void testTemperaturePersist() {
		...
		String persistTime = wController.persistTemperature(10, 19.5, fixedDate);
		...
		Assert.assertEquals("Persisted time should match expected fixed time", expectedTime, persistTime);
